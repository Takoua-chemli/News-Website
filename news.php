  ...
  <div class="container">
    <div class="page-container">
      ...
      <article class="card1">
        ...
        <div class="d-flex text-center">
          <?php
            ...
            if ($bookmarked) {
              echo '<a class="btn btn-bookmark" href="remove-bookmark.php?id='.$article_id.'">إزالة من الإشارة المرجعية &nbsp<i class="fas fa-bookmark"></i></a>';   
            }

            // If the article is not bookmarked
            else {
              echo '<a class="btn btn-bookmark" href="add-bookmark.php?id='.$article_id.'">أضف إلى الإشارة المرجعية &nbsp<i class="far fa-bookmark"></i></a>';   
            }
            echo'&nbsp';

            // Download button
            echo '<a class="btn btn-download" target="_blank" href="download-article.php?id='.$article_id.'">تحميل &nbsp<i class="fas fa-download"></i></a>';   
          ?>
        </div>
        <?php
            }
      ...
      <aside>
        ...
        <div class="card2">
          <h2 class="aside-title">يجب أن يقرأ</h2>
          <?php
          ...
          <div class="text-center py-1">
            <a href="search.php?trending=1" class="btn btn-card">عرض الكل <span>&twoheadrightarrow; </span>
            </a>
          </div>
        </div>
        ...
        <div class="card2">
          <h2 class="aside-title">يقرأ الناس أيضًا</h2>
          <?php
