    ...
    <form method="GET" class="search-article">
      <div class="box-container d-flex">
        <table class=".search-table">
          <tr>
            <td>
              <input class="search-input" type="text" name="name" id="name" placeholder="بحث" autocomplete="off" />
            </td>
          </tr>
        </table>
      </div>
      <div class="filters">
        ...
        <div>
          <label for="category_select">فئة</label>
          <select name="category_select" id="category_select">
            <option value="">حدد أي فئة</option>
            <?php
        ...
        <div>
          <label for="trending">آخر الأخبار</label>
...
<section class="py-1 category-list">
  <div class="container">
    <h2 class="search-heading">نتائج البحث </h2>
